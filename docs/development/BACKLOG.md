...
| # | Task ID | 標題 | 專案 | 負責人 (Assignee) | 狀態 (Status) |
|---|---------|------|------|-------------------|---------------|
| 1 | PEV-DEV-AGENT-035 | 建立雙入口模板與供應商 adapter manifests | process_evolution | system-architect | ⏳ Pending |
| 2 | PEV-DEV-AGENT-036 | installer 支援雙入口種子檔與模板升級 | process_evolution | devops-engineer | ⏳ Pending |
| 3 | PEV-DEV-AGENT-037 | 實作 agent runtime state、provider registry 與 init | process_evolution | backend-developer | ⏳ Pending |
| 4 | PEV-DEV-AGENT-038 | 實作 doctor／refresh 與 Claude、Codex、GitHub probes | process_evolution | devops-engineer | ⏳ Pending |
| 5 | PEV-DEV-AGENT-039 | 實作 route／explain 與失效重路由 | process_evolution | backend-developer | ⏳ Pending |
| 6 | PEV-DEV-AGENT-040 | 工單與審查流程接入能力路由證據 | process_evolution | scrum-master | ⏳ Pending |
| 7 | PEV-DEV-AGENT-041 | 安全遷移本 repo 的 Claude／Codex／GitHub 設定 | process_evolution | devops-engineer | ⏳ Pending |
| 8 | PEV-DEV-AGENT-042 | 混合代理路由與交接端到端驗證 | process_evolution | qa-automation-engineer | ⏳ Pending |
